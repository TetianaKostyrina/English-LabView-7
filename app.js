...
const VOCAB = [
  ...
  { en: "Remainder", ru: "остаток при делении", pron: "ри-МЭЙН-дэ" },
  { en: "Introduction", ru: "введение", pron: "ин-трэ-ДАК-шн" },
  { en: "Cases", ru: "случаи варианты", pron: "КЭЙ-сиз" },
  { en: "Each", ru: "каждый", pron: "ИИЧ" },
  { en: "Of", ru: "из", pron: "ов" },
  { en: "From", ru: "от / из источник", pron: "ФРОМ" },
];
