// ====== СЛОВА (ваш список) ======
const VOCAB = [
{ en: "Behavior", ru: "поведение", pron: "би-ХЕЙВ-ер" },
{ en: "Combine", ru: "объединять; совмещать", pron: "кэм-БАЙН" },
{ en: "Related", ru: "связанный; относящийся", pron: "ри-ЛЕЙ-тид" },
{ en: "Into", ru: "в; внутрь", pron: "ИН-ту" },
{ en: "Describe", ru: "описывать", pron: "ди-СКРАЙБ" },
{ en: "Arranged", ru: "расположенный; упорядоченный", pron: "э-РЕЙНДЖД" },
{ en: "Based", ru: "основанный (на)", pron: "БЕЙСТ" },
{ en: "Unnamed", ru: "безымянный; неназванный", pron: "ан-НЕЙМД" },
{ en: "Disassembly", ru: "разборка; демонтаж", pron: "дис-э-СЕМ-бли" },
{ en: "Populate", ru: "заполнять (данными)", pron: "ПО-пью-лейт" },
{ en: "Compose", ru: "составлять; создавать", pron: "кэм-ПОУЗ" },
{ en: "Warning", ru: "предупреждение", pron: "ВОР-нинг" },
{ en: "Heatstroke", ru: "тепловой удар", pron: "ХИТ-строук" },
{ en: "Resized", ru: "изменённый по размеру", pron: "ри-САЙЗД" },
{ en: "Fit", ru: "подгонка; соответствие", pron: "ФИТ" },
{ en: "Adjusts", ru: "регулирует; настраивает", pron: "э-ДЖАСТС" },
{ en: "Border", ru: "граница; рамка", pron: "БОР-дер" },
{ en: "Align", ru: "выравнивать", pron: "э-ЛАЙН" },
{ en: "Relationship", ru: "связь; отношение", pron: "ри-ЛЕЙ-шн-шип" },
];
